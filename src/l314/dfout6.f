...
C  COMMAND LINE: "ftangle -ybs15000 dfout6"
C  RUN TIME:     "Friday, June 5, 2009 at 15:05."
C  WEB FILE:     "dfout6.web"
C  CHANGE FILE:  (none)
      C* 1: * 
*line 35 "dfout6.web"
      subroutine dfout6(TQ1,TQ2,TQ3,DBUF,IBUF2E,DBUF2E,ISH,JSH,KSH,LSH,I
     &OP,D,F)
      implicit none
      double precision C1,C2,C3,C4,DBUF2E,Dumint,Exx,g1,G11,G12,G13,g2,G
     &21,G22,G23,g3,G31,G32,G33,Gint
