...
C  COMMAND LINE: "ftangle -ybs15000 dfout8"
C  RUN TIME:     "Friday, June 5, 2009 at 15:05."
C  WEB FILE:     "dfout8.web"
C  CHANGE FILE:  (none)
      C* 1: * 
*line 34 "dfout8.web"
      subroutine dfout8(TQ1,TQ2,TQ3,DBUF,IBUF2E,DBUF2E,ISH,JSH,KSH,LSH,I
     &OP,D,F)
      implicit none
     ...
     &,k,Kend,Kml,Krange,Ks1,Ks2,Ks3
      integer KSH,kst,Kstart,Kstm,l,lambda,Lbound,Lend,Lentq,lim,Lrange,
...
99006 format(' IN DFOUT8, ISH, ETC=',4I3)
