...
C  COMMAND LINE: "ftangle -ybs15000 geta2"
C  RUN TIME:     "Friday, June 5, 2009 at 15:05."
C  WEB FILE:     "geta2.web"
C  CHANGE FILE:  (none)
      C* 1: * 
*line 15 "geta2.web"
      subroutine geta2
      implicit none
      double precision A,Ep,Eq,Eqsav,Exparg,Five,Four,One,Pexp,Pp,Ptest,
     &qq,Qxpsav,Qxsav,Qysav,Qzsav,Three,Two,Xint,Zero
      integer Klcutq,Klind,Lamax,Lbmax,Lcmax,Ldmax,Lpmax,Lpqmax,Lqmax
      common/qinfo/Eqsav(100),Qxsav(100),Qysav(100),Qzsav(100),Qxpsav(10
     &0),Exparg,Ptest,Pexp,Ep,Eq,Pp,Klind,Klcutq(100)
      common/a/A(174)
      common/max/Lamax,Lbmax,Lcmax,Ldmax,Lpmax,Lqmax,Lpqmax
      common/int/Zero,Xint(12)
      equivalence(One,Xint(1)),(Two,Xint(2)),(Three,Xint(3)),(Four,Xint(
     &4)),(Five,Xint(5))
