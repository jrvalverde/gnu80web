...
C  COMMAND LINE: "ftangle -ybs15000 dfout1"
C  RUN TIME:     "Friday, June 5, 2009 at 15:05."
C  WEB FILE:     "dfout1.web"
C  CHANGE FILE:  (none)
      C* 1: * 
*line 36 "dfout1.web"
      subroutine dfout1(TQ1,TQ2,TQ3,DBUF,IBUF2E,DBUF2E,ISH,JSH,KSH,LSH,I
     &OP,D,F)
      implicit none
      double precision C1,C2,C3,C4,DBUF2E,Exx,g1,G11,G12,G13,g2,G21,G22,
     &G23,g3,G31,G32,G33,Gint,pt25
      double precision TQ1,TQ2,TQ3,X,Y,Z
     ...
     &,k,Kend,Kml,Krange,Ks1,Ks2,Ks3
      integer KSH,kst,Kstart,Kstm,l,lambda,Lbound,Lend,Lentq,Lrange,LSH,
     &lst,Lstart,Lstm,MAXPRM,MAXS21,MAXSH1,MAXSHL,Maxtyp,mu
      integer N10ord,N5ord,N6ord,N7ord,Nfa,Nfb,Nfc,Nfd,Nordr,Nshell,nu,N
     &umdf
      integer IOP(*)
     ...
     &nd(4,3),Ubound(4),Ulpure(4)
      ...
      call out2e(3,mu,nu,lambda,sigma,Gint,DBUF,IBUF2E,DBUF2E,iret,idcou
     &t,IOP,D,F)
...
99006 format(' IN DFOUT1, ISH, ETC=',4I3)
