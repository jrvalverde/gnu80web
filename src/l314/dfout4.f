...
C  COMMAND LINE: "ftangle -ybs15000 dfout4"
C  RUN TIME:     "Friday, June 5, 2009 at 15:05."
C  WEB FILE:     "dfout4.web"
C  CHANGE FILE:  (none)
      C* 1: * 
*line 35 "dfout4.web"
      subroutine dfout4(TQ1,TQ2,TQ3,DBUF,IBUF2E,DBUF2E,ISH,JSH,KSH,LSH,I
     &OP,D,F)
      implicit none
      double precision C1,C2,C3,DBUF2E,Exx,g1,G11,G12,G13,g2,G21,G22,G23
     &,g3,G31,G32,G33,Gint,pt25,TQ1
      double precision TQ2,TQ3,X,Y,Z
     ...
     &nd(4,3),Ubound(4),Ulpure(4)
      ...
      call out2e(1,mu,nu,lambda,sigma,Gint,DBUF,IBUF2E,DBUF2E,iret,idcou
     &t,IOP,D,F)
...
99006 format(' IN DFOUT4, ISH, ETC=',4I3)
